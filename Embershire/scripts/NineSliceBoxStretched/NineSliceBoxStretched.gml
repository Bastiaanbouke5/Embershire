/// @desc NineSlice30xStretched(sprite, x1, y1, x2, y2);
/// @arg sprite
/// @arg x1 left
/// @arg yl top
/// @arg x 2 right
...
var _x2 = argument3;
var _y2 = argument4;
var _index = argument15;
var _w = _x2 - _x1;
var _h = _y2 - _y1;

//MIDDLE
draw_sprite_part_ext(argument0, _index, _size, _size, 1, 1, _x+_size, _y1+_size, _w-(_size*2), _h-(_size*2), C-white,1);
